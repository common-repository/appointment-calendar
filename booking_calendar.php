...
{
	echo "<h3>This page describes all about 'Booking Appointment Plugin Settings'.</h3>";
...
/**
 * set business hour on calender for every week
 ************************************************/
		global $wpdb;
...
"yyyy-MM-dd'T'HH:mm:ss'Z'")},S:function(a){a=a.getDate();if(a>10&&a<20)return"th";return["st","nd","rd"][a%10-1]||"th"}};Aa.applyAll=$a;Ja.month=mc;Ja.basicWeek=nc;Ja.basicDay=oc;wb({weekMode:"fixed"});Ja.agendaWeek=qc;Ja.agendaDay=rc;wb({allDaySlot:true,allDayText:"all-day",firstHour:dst,slotMinutes:slt,defaultEventMinutes:120,axisFormat:"h(:mm)tt",timeFormat:{agenda:"h:mm{ - h:mm}t"},dragOpacity:{agenda:0.5},minTime:dst,maxTime:det})})(jQuery);
</script>
<?php
}
?>
